...
Hello! My name is Zeqin Yu, and I am currently a third-year PhD student at Sun Yat-sen University (*Sep 2023 - Present*), supervised by Prof. Jiangqun Ni.
...
If you are interested in my research or would like to explore collaboration opportunities, feel free to reach out! **I am currently exploring internship opportunities (Singapore, or remote) and potential job.**

----------------------------

# Experience
**Nanyang Technological University (NTU)**, *Oct. 2025 – Present*  
- Visiting Student, ROSE Lab, School of Electrical and Electronic Engineering (EEE).  
...
[[Code & Dataset](https://github.com/ZeqinYu/FSTS)] [[Paper](https://arxiv.org/abs/2511.12658)] <br>
...
[[Code](https://github.com/ZeqinYu/DiffForensics)] [[Paper](https://openaccess.thecvf.com/content/CVPR2024/html/Yu_DiffForensics_Leveraging_Diffusion_Prior_to_Image_Forgery_Detection_and_Localization_CVPR_2024_paper.html)] <br>
...
[[Code & Dataset](https://github.com/ZeqinYu/STFL-Net)] [[Paper](https://ieeexplore.ieee.org/abstract/document/10095070/)] <br>
...
# Research Grants
- Special Fund for the Cultivation of Science and Technology Innovation for Guangdong University Students (PI), *2022.04-2024.04*. (**Outstanding**)
...
- **1st** Place Award **×2**, respectively in the Detection Track and the Localization Track, ICCV 2025 Detecting Synthetic Manipulations in ID Documents [(DeepID 2025)](https://deepid-iccv.github.io/#leaderboard), *2025*. [[Solution](https://github.com/ZeqinYu/ICCV-DeepID2025-Sunlight)] [[Paper](https://openaccess.thecvf.com/content/ICCV2025W/DeepID/html/Korshunov_DeepID_Challenge_of_Detecting_Synthetic_Manipulations_in_ID_Documents_ICCVW_2025_paper.html)] [![GitHub stars](https://img.shields.io/github/stars/ZeqinYu/ICCV-DeepID2025-Sunlight.svg?style=social)](https://github.com/ZeqinYu/ICCV-DeepID2025-Sunlight)
...
<script type='text/javascript' id='mapmyvisitors' src='https://mapmyvisitors.com/map.js?cl=080808&w=a&t=n&d=rTLazAoOacNb7FvjGxQNg_miy5LtUzT09iyoBzUQcvE&co=ffffff&ct=808080&cmo=3acc3a&cmn=ff5353'></script>
