...
- **1st** Place Award, Detection Track — Detecting Synthetic Manipulations in ID Documents (ICCV DeepID 2025) [(Leaderboard)](https://deepid-iccv.github.io/#leaderboard), *2025*.
- **1st** Place Award, Localization Track — Detecting Synthetic Manipulations in ID Documents (ICCV DeepID 2025)[(Leaderboard)](https://deepid-iccv.github.io/#leaderboard), *2025*.
